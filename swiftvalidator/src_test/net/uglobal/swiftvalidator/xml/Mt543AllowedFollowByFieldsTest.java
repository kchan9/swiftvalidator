...
public class Mt543AllowedFollowByFieldsTest extends AbstractMtAllowedFollowByFieldsTest {
		...
		return new ArrayList<Integer[]>() {
			{
				...
				add(new Integer[] { 69, 70 });
				add(new Integer[] { 64, 71, 76 });
				add(new Integer[] { 72 });
				add(new Integer[] { 72, 73, 74, 75 });
				add(new Integer[] { 73, 74, 75 });
				add(new Integer[] { 74, 75 });
				add(new Integer[] { 71, 76 });
				add(new Integer[] { 77, 78 });
				add(new Integer[] { 77, 78 });
				add(new Integer[] { 78, 79, 80, 81 });
				add(new Integer[] { 80, 81 });
				add(new Integer[] { 81 });
				add(new Integer[] { 76, 82 });
				add(new Integer[] { 83 });
				add(new Integer[] { 84 });
