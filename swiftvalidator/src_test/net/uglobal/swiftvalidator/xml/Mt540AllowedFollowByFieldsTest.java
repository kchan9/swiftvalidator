...
public class Mt540AllowedFollowByFieldsTest extends AbstractMtAllowedFollowByFieldsTest {
		...
		return new ArrayList<Integer[]>() {
			{
				...
				add(new Integer[] { 17, 18 }); // 16
				add(new Integer[] { 18 });//17
				...
				add(new Integer[] { 77, 78 }); //77
				add(new Integer[] { 78, 79, 80 });
				add(new Integer[] { 80 });
				add(new Integer[] { 81, 76 });
